...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (!number) return api.sendMessage("Xem id nhân vật tại đây:https://apitntxtrick.onlitegix.com/", event.threadID);

  try {
    const response = await axios.get(`https://apitntxtrick.onlitegix.com/genshin/info?id=${number}`);
