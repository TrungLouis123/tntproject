...
const login = require("./Project_Database/fca-boom"); 
...
const { Sequelize, sequelize } = require("./Project_Database/database");
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        const listener = require('./Project_Database/listen')(listenerData);
    ...
    try {
        try {
            ...
            const sequelize2 = new Sequelize({
                dialect: "sqlite",
                host: __dirname + '/Project_Database/datasqlite/antists.sqlite',
                logging: false
            });
        ...
        authentication.sequelize = sequelize;
        const models = require('./Project_Database/database/model')(authentication);
        const botData = {};
